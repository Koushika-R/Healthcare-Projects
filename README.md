...
Task3_Breast Cancer Wisconsin (Diagnostic) Dataset - This project applies a simple neural network (TensorFlow/Keras) to classify breast cancer tumors as benign or malignant using the Breast Cancer Wisconsin dataset. The model was trained on 30 diagnostic features and achieved ~97% accuracy on the test set.
